...
class SimpleDrivingEnv(gym.Env):
    ...
    def step(self, action):
        ...
        reward = 100/dist_to_goal  # with a scale factor
        ...
        if (car_ob[0] >= 6 or car_ob[0] <= -6 or
            ...
            self.done = True
        elif any(dist < 0.7 for dist in dist_to_obstacles):  # Done if any obstacle is hit
            self.done = True
            reward = -500
    ...
    def reset(self):
        ...
        self.obstacles = [(4,-2), (3,4), (-4,5)]  # Set obstacle positions
        self.done = False
